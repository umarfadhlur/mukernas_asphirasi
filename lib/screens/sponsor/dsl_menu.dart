...
class DslMenu extends StatefulWidget {
  const DslMenu({super.key});

  @override
  State<DslMenu> createState() => _DslMenuState();
}

class _DslMenuState extends State<DslMenu> {
  int _currentIndex = 0;

  final List<String> _images = [
    "assets/materi/dsl_materi1.png",
    "assets/materi/dsl_materi2.png",
    "assets/materi/dsl_materi3.png",
    "assets/materi/dsl_materi4.png",
  ];
