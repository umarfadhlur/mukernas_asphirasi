...
class GreyfurtMenu extends StatefulWidget {
  const GreyfurtMenu({super.key});

  @override
  State<GreyfurtMenu> createState() => _GreyfurtMenuState();
}

class _GreyfurtMenuState extends State<GreyfurtMenu> {
  int _currentIndex = 0;

  final List<String> _images = [
    "assets/materi/greyfurt_materi1.png",
    "assets/materi/greyfurt_materi2.png",
  ];
