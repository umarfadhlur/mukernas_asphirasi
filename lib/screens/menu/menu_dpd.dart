...
class MenuDpd extends StatefulWidget {
  const MenuDpd({super.key});

  @override
  State<MenuDpd> createState() => _MenuDpdState();
}

class _MenuDpdState extends State<MenuDpd> {
  int _currentIndex = 0;

  final List<String> _images = [
    "assets/materi/dpd1.png",
    "assets/materi/dpd2.png",
  ];
