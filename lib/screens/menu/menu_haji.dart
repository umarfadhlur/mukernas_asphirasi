...
class MenuHaji extends StatefulWidget {
  const MenuHaji({super.key});

  @override
  State<MenuHaji> createState() => _MenuHajiState();
}

class _MenuHajiState extends State<MenuHaji> {
  int _currentIndex = 0;

  final List<String> _images = [
    "assets/materi/haji1.jpg",
    "assets/materi/haji2.jpg",
    "assets/materi/haji3.jpg",
  ];
